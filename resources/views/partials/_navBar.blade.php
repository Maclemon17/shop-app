...
<div class="mercado-clone-wrap">
    <div class="mercado-panels-actions-wrap">
        <a class="mercado-close-btn mercado-close-panels" href="#">&times;</a>
    </div>
                                ...
                                @auth
                                    @if (Auth::user()->user_type === "ADMIN")
                                        ...
                                        <li class="menu-item menu-item-has-children parent" > 
                                            ...
                                            <ul class="submenu curency" >
                                                <li class="menu-item" >
                                                    <a title="Admin Dashboard" href="{{ route('AdminDashboard') }}">Dashboard</a>
                                                </li>
                                                <li class="menu-item">
                                    ...
                                    @else
                                        ...
                                        <li class="menu-item menu-item-has-children parent" >
                                            ...
                                            <ul class="submenu curency" >
                                                <li class="menu-item" >
                                                    <a title="Admin Dashboard" href="{{ route('UserDashboard') }}">Dashboard</a>
                                                </li>
                                                <li class="menu-item">
                                                    <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
                                                </li>
